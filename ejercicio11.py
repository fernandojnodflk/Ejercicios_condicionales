...
print("HOLA :)")
duracion_llamada = int(input("Ingresa la duración de la llamada en minutos: "))
dia_semana = int(input("Ingresa el día de la semana (1 = lunes, 7 = domingo): "))
turno = input("Ingresa el turno (mañana/tarde): ").lower()
